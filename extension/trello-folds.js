...
const tfolds = (function (factory) {
    ...
    const self = {
        ...
        showSections(sections) {
            ...
            // Collapse all
            $sections = tdom.getCardsByName(self.sectionIdentifier, false);
            $sections.each((i, section) => {
